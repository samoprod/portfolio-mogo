...
$(function(){$(".slick-hdr").slick({slidesToShow:1,slidesToScroll:1,arrows:!1,dots:!1,asNavFor:".slick-hdr-nav",autoplay:!0,autoplaySpeed:3e3}),$(".slick-hdr-nav").slick({slidesToShow:4,slidesToScroll:1,asNavFor:".slick-hdr",dots:!1,focusOnSelect:!0}),$(".slick-citates").slick({nextArrow:'<button class="arrcit nextarrcit"><i class="fa fa-angle-right"></i></button>',prevArrow:'<button class="arrcit prevarrcit"><i class="fa fa-angle-left"></i></button>'}),$(".nav-hdr-dot").mouseover(function(){$(".slick-hdr").slick("slickPause")}).mouseout(function(){$(".slick-hdr").slick("slickPlay")}),$(".slick-hdr").mouseover(function(){$(".slick-hdr").slick("slickPause"),$(".nav-hdr-dot").addClass("paused")}).mouseout(function(){$(".slick-hdr").slick("slickPlay"),$(".nav-hdr-dot").removeClass("paused")}),$(".hamburger").click(function(){$(this).toggleClass("is-active fixed"),$(".nav").slideToggle(400,function(){$(".icons-hdr").toggle(300)})}),$(window).scroll(function(){70<$(window).scrollTop()?$(".top-menu").addClass("fixedtop"):$(".top-menu").removeClass("fixedtop")}),new SimpleBar($(".tab-text")[0],{autoHide:!1}),new SimpleBar($(".tab-text")[1],{autoHide:!1}),new SimpleBar($(".tab-text")[2],{autoHide:!1}),$(".tab-heading").click(function(){$(this).next().slideToggle(),$(this).find(".fa").toggleClass("angled")}),wall.container.find("a").find("img").on("load",function(){wall.fitWidth()});new LazyLoad({elements_selector:".lazy"});function o(e,o,t){e.countTo({from:0,to:o,speed:t,refreshInterval:10,onComplete:function(e){console.debug(this)}})}$(".gallery").magnificPopup({delegate:"a",type:"image",removalDelay:300,mainClass:"mfp-fade"}),$("a").not(".nota").click(function(e){e.preventDefault()}),$(".closebtn span").click(function(){$(".bg").fadeOut(400)}),$(".map-marker").click(function(){$(".bg").fadeIn(400)}),$(".s-counts").waypoint(function(e){"down"==e&&768<$(window).width()&&(o($(".h3-count-1"),42,1e3),o($(".h3-count-2"),123,1e3),o($(".h3-count-3"),15,1e3),o($(".h3-count-4"),99,1e3),o($(".h3-count-5"),24,1e3))},{offset:"80%"});var e="";function t(o,t,e){o.waypoint(function(e){"down"==e?o.addClass("animated "+t):o.removeClass("animated "+t)},{offset:e+"%"})}$(".nav li a").click(function(){$(".nav li a").removeClass("active"),$(this).addClass("active"),e=$(this).attr("href").split("#")[1],$("body,html").stop().animate({scrollTop:$("."+e).offset().top-50},800,"linear")}),$(window).on("scroll",function(){$(window).scrollTop()>=$(".s-about-us").offset().top-200?$(".toup").stop().animate({right:10},400,"linear"):$(window).scrollTop()<$(".s-about-us").offset().top-200&&$(".toup").stop().animate({right:-50},400,"linear")}),$(".toup, .logo").click(function(){$("body,html").animate({scrollTop:0},800,"linear"),$(".nav li a").removeClass("active")}),t($(".s-about-us"),"bounceInLeft","80"),t($(".s-services"),"slideInRight","80"),t($(".s-unique"),"fadeInUp","80"),t($(".s-end"),"fadeInDown","90"),t($(".s-what-we-do"),"zoomIn","80"),t($(".s-gallery"),"bounceInLeft","80"),t($(".fbs-item"),"bounceInRight","60")});var wall=new freewall(".gallery");wall.reset({selector:"a",animate:!0,cellW:180,cellH:"auto",gutterX:0,gutterY:0,onResize:function(){wall.fitWidth()}}),$(window).on("load",function(){$("body").removeClass("ovh"),$("body, html").animate({scrollTop:0},400),$(".my-col-2").equalHeights(),$(".preloader").fadeOut(400)});